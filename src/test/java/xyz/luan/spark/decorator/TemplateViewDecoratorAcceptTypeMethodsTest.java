...
public class TemplateViewDecoratorAcceptTypeMethodsTest extends BaseTest {
    ...
    static class ApplicationTest implements SparkApplication {
        ...
        public void init() {
            ...
            templateWithLogger.get("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.post("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.put("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.patch("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.delete("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.head("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.options("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.trace("/foo", "text/plain", (req, resp) -> mnv, engine);
            templateWithLogger.connect("/foo", "text/plain", (req, resp) -> mnv, engine);
        }
    }
